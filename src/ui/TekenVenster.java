...
public class TekenVenster extends Canvas {
	...
	public void paint(Graphics graphics) {
		...
		//schrijf for loop to check vormen uit arraylist<vorm> van  tekening, dan if statements om te filteren op type vorm en de parameter eruithalen en in graphics.drawX steken.
